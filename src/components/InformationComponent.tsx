                ...
                <CardHeader>
                    <div className="flex flex-col gap-4">
                        <Avatar className="h-36 w-36">
                            <AvatarImage src="/images/profilePhoto.png" alt="Francisco Borges" />
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                ...
                                <a href="https://www.uminho.pt/PT" target="_blank" rel="noopener noreferrer" className="hover:underline">
                                    @uminho
                                </a>
                            </p>
                            <p className="text-muted-foreground">
                                Working{" "}
                                <a href="https://www.ccg.pt/" target="_blank" rel="noopener noreferrer" className="hover:underline">
                                    @CCG
                                </a>
                            </p>
                        </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-around flex-wrap gap-8 w-full">
                            <Button variant="outline" size="icon" asChild className="p-2">
                                <a href="https://github.com/franciscoborges2002" target="_blank" rel="noopener noreferrer">
                            ...
                            <Button variant="outline" size="icon" asChild className="p-2">
                                <a href="https://www.linkedin.com/in/francisco-borges2002" target="_blank" rel="noopener noreferrer">
                                    <Linkedin className="h-5 w-5" />
                                    <span className="sr-only">LinkedIn</span>
                                </a>
                            </Button>
                            <Button variant="outline" size="icon" asChild className="p-2">
                                <a href="https://www.youtube.com/@franciscoborges7897" target="_blank" rel="noopener noreferrer">
                                    <Youtube className="h-5 w-5" />
                                    <span className="sr-only">YouTube</span>
                                </a>
                            </Button>
                            <Button variant="outline" size="icon" asChild className="p-2">
                                <a href="https://leetcode.com/u/fborges/" target="_blank" rel="noopener noreferrer">
                                    <SiLeetcode className="h-5 w-5" />
                                    <span className="sr-only">LeetCode</span>
                                </a>
                            </Button>
                            <Button variant="outline" size="icon" asChild className="p-2">
                                <a href="https://tryhackme.com/p/fborges02" target="_blank" rel="noopener noreferrer">
                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor">
                        ...
                        <ol className="relative space-y-4 overflow-y-auto scrollbar-thin scrollbar-webkit" style={{ maxHeight: "150px" }}>
                            {[
                                ...
                                },
                                {
                                    ...
                                    description: "Worked as lead mobile & frontend developer. Conducted a team of 3 developers to build the interface for the event application.",
                                },
                                {
                                    ...
                                    company: "@AIS.SC",
                                    url: "https://aissc.dsi.uminho.pt/",
                                    description: "Worked mainly in backend, modifying, upgrading and researching new features to service.",
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    company: "@ioTech",
                                    url: "https://iotech.pt/",
                                    description: "Made an integration between APIs for an Industry 4.0 project.",
                                },
                            ].map((item, i) => (
                            ...
                            {[
                                {
                                    ...
                                    degree: "Master in Engineering and Management of Information Systems",
                                    institution: "@Uminho",
