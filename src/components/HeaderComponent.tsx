            ...
            <div className="w-full flex items-center gap-5 pt-2 px-4 md:px-10 min-h-14">
                ...
                <div className="flex-1 flex justify-end items-center gap-1">
                    <nav className="hidden md:flex items-center">
                        <Link to="/" className="px-2 py-1 rounded hover:bg-white/5">{t('header.home')}</Link>
                        <Link to="/projects" className="px-2 py-1 rounded hover:bg-white/5">{t('header.projects')}</Link>
                        <Link to="/articles" className="px-2 py-1 rounded hover:bg-white/5">{t('header.articles')}</Link>
                        <LanguageComponent />
                        <ThemeToggle />
                    </nav>
                    ...
                    <div className="relative md:hidden">
                        ...
                        >
                            <nav className="py-2 text-white/90">
                                <Link className="block px-3 py-2 rounded hover:bg-white/5" to="/">{t('header.home')}</Link>
                                <Link className="block px-3 py-2 rounded hover:bg-white/5" to="/projects">{t('header.projects')}</Link>
                                <Link className="block px-3 py-2 rounded hover:bg-white/5" to="/articles">{t('header.articles')}</Link>
